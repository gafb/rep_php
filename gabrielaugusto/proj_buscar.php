            ...
            ?>
             <p>
                                        <form class="search-form" method='POST'>
                                          <label>
                                            Valor que deseja pesquisar no nome ou crm:
                                            <input name="buscar" type="text" class="form-control" placeholder="Digite aqui..."/>
                  ...
                  <BODY>
                     ...
                     <?php
                              ...
                              if (isset($_REQUEST["excluir"]) && $_REQUEST["excluir"]==true )
                              {
                                ...
                                $rs =$connection->prepare("SELECT * FROM medicos WHERE nome  LIKE ? or CRM LIKE ?");
                                 
                                $rs->bindParam(1,$_POST["buscar"]);
                                $rs->bindParam(2,$_POST["buscar"]);
